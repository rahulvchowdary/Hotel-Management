 ...
 * @author rahul
 */
public class RBP extends javax.swing.JFrame {

    /**
     * Creates new form RBP
     */
    public RBP() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Single Room - ₹1000", "Double Room - ₹1500", "Deluxe Room - ₹2000", "Suite - ₹3000" }));
        ...
        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 530, 280));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        String Username = jTextField1.getText();
        String ItemSel = jComboBox1.getSelectedItem() + "";
        int Room = Integer.parseInt(jTextField2.getText());
        int ItemCost = 0;
        if (ItemSel.equals("None")){
            ItemCost = 0;
            int Price = ItemCost * Room;
            jTextField3.setText("" + Price );
        }
        else if (ItemSel.equals("Single Room - ₹1000")){
            ItemCost = 1000;
            int Price = ItemCost * Room;
            jTextField3.setText("" + Price );
        }
        else if (ItemSel.equals("Double Room - ₹1500")){
            ItemCost = 1500;
            int Price = ItemCost * Room;
            jTextField3.setText("" + Price );
        }
        else if (ItemSel.equals("Deluxe Room - ₹2000")){
            ItemCost = 2000;
            int Price = ItemCost * Room;
            jTextField3.setText("" + Price );
        }
        else if (ItemSel.equals("Suite - ₹3000")){
            ItemCost = 3000;
            int Price = ItemCost * Room;
            jTextField3.setText("" + Price );
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RBP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
